...
Reg_addr ="RAYB1233388" #None #if None, Reg_addr = MAC address (can run only one dummy device)

DAN.profile['dm_name']='Dummy_Device'   #dm = device module
DAN.profile['df_list']=['Dummy_Sensor', 'Dummy_Control',]
DAN.profile['d_name']= 'RAY_weather.OUT' 
